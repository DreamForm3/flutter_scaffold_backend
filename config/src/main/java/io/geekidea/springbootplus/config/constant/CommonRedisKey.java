...
public interface CommonRedisKey {
    ...
    /**
     * 模糊查询数据缓存key，规则是fuzzy-search-cache:<对象名称>:<对象ID>:<模糊查询条件，如果有多个，用:隔开>
     * 例如data-cache:customer:123456:张三:15852711234
     */
    String FUZZY_SEARCH_CACHE = "fuzzy-search-cache:%s:%s:%s";

    /**
     * 调度锁的key
     */
    String SCHEDULE_LOCK = "schedule-lock:%s";

    /**
     * 查询缓存的前缀
     */
    String QUERY_CACHE_PREFIX = "query-cache:";
}
