...
exec sp_addextendedproperty 'MS_Description', '头像', 'SCHEMA', 'dbo', 'TABLE', 'sys_user', 'COLUMN', 'avatar'
go
...
INSERT INTO spring_boot_plus.dbo.sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1006, '用户修改头像', 100, null, 'sys:user:update:avatar', null, 2, 3, 1, 0, null, 0, '2019-10-26 11:18:40.000', null);
...
INSERT INTO spring_boot_plus.dbo.sys_user (id, username, nickname, password, salt, phone, gender, avatar, remark, state, department_id, role_id, deleted, version, create_time, update_time) VALUES (1, 'admin', '管理员', '11a254dab80d52bc4a347e030e54d861a9d2cdb2af2185a9ca4a7318e830d04d', '666', '', 1, 'http://localhost:8888//resource/201910281559227.jpg', 'Administrator Account', 1, 1, 1, 0, 1, '2019-08-26 00:52:01.000', '2019-10-27 23:32:29.000');
INSERT INTO spring_boot_plus.dbo.sys_user (id, username, nickname, password, salt, phone, gender, avatar, remark, state, department_id, role_id, deleted, version, create_time, update_time) VALUES (2, 'test', '测试人员', '34783fb724b259beb71a1279f7cd93bdcfd92a273d566f926419a37825c500df', '087c2e9857f35f1e243367f3b89b81c1', '', 1, null, 'Tester Account', 1, 1, 2, 0, 0, '2019-10-05 14:04:27.000', null);
