### 基于 spring-boot-plus 脚手架再次修改
- 解决了原版代码生成器生成的 Controller 接口代码一点都不 Restful 的问题
- 数据库换成了 PostgreSQL
- 业务代码可以使用父子 module 结构，具体请参考 modules 下的代码
- 优化了基础实体对象的继承关系，代码生成器也做了相应变更，不会在子类中生成父类的字段
- 处理了逻辑删除逻辑
- 增加了 redis 分布锁，详见 io.geekidea.springbootplus.scheduled.DataCacheScheduled.customerDataCacheSchedule 方法
- 增加了 redis 模糊查询（避免数据库 like 不走索引查询速度太慢）以及 redis 查询缓存，详见 com.lakecloud.scaffold.service.impl.CustomerServiceImpl 相关的方法

### spring-boot-plus 脚手架本身的功能请查看下方的介绍
